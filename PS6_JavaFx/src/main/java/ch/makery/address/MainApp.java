...
//alerts aren't working with my eclipse for some reason but i kept them anyway since they were here originally
public class MainApp extends Application {
	...
	public void RefreshPersonTable() {
		...
		for (PersonDomainModel p : people) {
			personData.add(new Person(p.getFirstName(), p.getLastName(), p.getStreet(), p.getPostalCode(), p.getCity(),
					p.getBirthday()));
		}
	}
